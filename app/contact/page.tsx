            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987c6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297L3.89 16.927c-.854-.854-1.297-2.025-1.297-3.323s.443-2.469 1.297-3.323L5.126 8.945c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297l1.236 1.236c.854.854 1.297 2.025 1.297 3.323s-.443 2.469-1.297 3.323l-1.236 1.236c-.875.807-2.026 1.297-3.323 1.297z"/>
                    </svg>
                  </a>
                  <a 
